 ...
 */
public class JPopUp_Menu extends JFrame implements ActionListener {
    ...
    public JPopUp_Menu() {
        ...
        miCopiarContextual.setActionCommand("Copiar");
        miCopiarContextual.addActionListener(this);
        JMenuItem miCortarContextual = new JMenuItem("Cortar");
        miCortarContextual.setActionCommand("Cortar");
        miCortarContextual.addActionListener(this);
    ...
    public static void main(String[] args) {
        JPopUp_Menu ejemplo = new JPopUp_Menu();
    }
    ...
    private void accionCopiar() {
        editor.setText("Pulsado copiar");
    }    
    
    private void accionCortar() {
        editor.setText("Pulsado cortar");
    }
